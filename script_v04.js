...
function setBtnContainerPos(){
    ...
    if(isVertical){
        ...
        btnContainer.style.left = screenWidth - btnContainerRect.width - (screenWidth * 0.04) + "px";
        btnContainer.style.top = screenHeight - btnContainerRect.height - (screenHeight * 0.055) + "px";
...
function setBtnSize(){
    if(isVertical){
        ...
        for(let i of btnList){
            ...
            i.style.height = `${screenWidth * 0.04}px`;
        };
    };
};
